      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {[
            {
              q: "من يمكنه الانضمام؟",
              a: "المجتمع مخصص حصرياً لأصحاب الشركات والمدراء التنفيذيين ومديري الأقسام. يتم التحقق من الهوية والصفة عبر نموذج التقديم.",
            },
            {
              q: "كيف يتم القبول؟",
              a: "نراجع الطلبات خلال فترة قصيرة. حال الموافقة، نرسل لك رابط دعوة خاص على البريد لتنضم عبر منصة Circle.",
            },
            {
              q: "ما هي مواعيد البثوث؟",
              a: "كل سبت وإثنين وأربعاء الساعة 22:00. تُسجَّل الجلسات وتُنشر داخل المجتمع مع خلاصة تنفيذية.",
            },
            {
              q: "هل هناك فترة تجريبية؟",
              a: "يمكن توفير تجربة 15 يوماً بشكل محدود للحملات الخاصة. تفاصيل الباقات والأسعار تُرسل بعد القبول.",
            },
            {
              q: "ما تكلفة العضوية؟",
              a: "تختلف الباقات حسب المستوى: Basic للمحتوى المسجل، VIP للجلسات المباشرة، VIP+ للأيام الدراسية. التفاصيل تُرسل عند القبول.",
            },
            {
